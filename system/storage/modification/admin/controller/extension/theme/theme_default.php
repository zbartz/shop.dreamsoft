...
class ControllerExtensionThemeThemeDefault extends Controller {
	...
	public function index() {
		...
		$data['entry_image_subcategory'] = $this->language->get('entry_image_subcategory');
		...
		if (isset($this->error['image_subcategory'])) {
			$data['error_image_subcategory'] = $this->error['image_subcategory'];
		} else {
			$data['error_image_subcategory'] = '';
		}
		...
		if (isset($this->request->post['theme_default_image_subcategory_width'])) {
			$data['theme_default_image_subcategory_width'] = $this->request->post['theme_default_image_subcategory_width'];
		} elseif (isset($setting_info['theme_default_image_subcategory_width'])) {
			$data['theme_default_image_subcategory_width'] = $this->config->get('theme_default_image_subcategory_width');
		} else {
			$data['theme_default_image_subcategory_width'] = '';		
		}
		
		if (isset($this->request->post['theme_default_image_subcategory_height'])) {
			$data['theme_default_image_subcategory_height'] = $this->request->post['theme_default_image_subcategory_height'];
		} elseif (isset($setting_info['theme_default_image_subcategory_height'])) {
			$data['theme_default_image_subcategory_height'] = $this->config->get('theme_default_image_subcategory_height');
		} else {
			$data['theme_default_image_subcategory_height'] = '';
		}
	...
	protected function validate() {
		...
		if (!$this->request->post['theme_default_image_subcategory_width'] || !$this->request->post['theme_default_image_subcategory_height']) {
			$this->error['image_subcategory'] = $this->language->get('error_image_subcategory');
		}
