  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="col-sm-12">
          <table id="module-extra-positions" class="table table-striped table-bordered table-hover">
            <thead>
            <tr>
                <td class="text-center">Extra Positions</td>
            </tr>
            </thead>
            <tbody>
            <?php foreach ($layout_modules as $layout_module) { ?>
              <?php if (!in_array($layout_module['position'], array('content_top', 'content_bottom', 'column_left', 'column_right'))) { ?>
                <tr id="module-row<?php echo $module_row; ?>">
                  <td class="text-left"><div class="input-group">
                      ...
                      <select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control input-sm">
            ...
            <tr>
              <td class="text-left"><div class="input-group">
                  ...
                  <div class="input-group-btn">
                    <button type="button" onclick="vieAddModule('extra-positions');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
                  </div>
                </div></td>
            </tr>
            </tfoot>
...
function addModule(type) {
	...
	module_row++;
      ...
      <?php } ?>
        html += '  </select>';
        html += '  <select name="layout_module[' + module_row + '][position]" class="form-control input-sm">';
        <?php foreach ($extra_positions as $position_code => $position_name) { ?>
      ...
      $('#module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-extra-positions')
      .delegate('select[name*=\'code\']', 'change', function() {
