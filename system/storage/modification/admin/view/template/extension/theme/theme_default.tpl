  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
		...
		<div class="form-group required">
		  <label class="col-sm-2 control-label" for="input-image-subcategory-width"><?php echo $entry_image_subcategory; ?></label>
		  <div class="col-sm-10">
			<div class="row">
			  <div class="col-sm-6">
				<input type="text" name="theme_default_image_subcategory_width" value="<?php echo $theme_default_image_subcategory_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-image-subcategory-width" class="form-control" />
			  </div>
			  <div class="col-sm-6">
				<input type="text" name="theme_default_image_subcategory_height" value="<?php echo $theme_default_image_subcategory_height; ?>" placeholder="<?php echo $entry_height; ?>" class="form-control" />
			  </div>
			</div>
			<?php if ($error_image_subcategory) { ?>
			  <div class="text-danger"><?php echo $error_image_subcategory; ?></div>
			<?php } ?>
		  </div>
		</div>
