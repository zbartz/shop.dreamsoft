    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div class="row">
        <div class="<?php echo $class; ?>">
            <h1 class="title_product"><?php echo $heading_title; ?></h1>
        </div>
        <?php if ($column_left || $column_right) { ?>
        <?php $class = 'col-sm-6'; ?>
        <?php } else { ?>
        ...
        <div class="<?php echo $class; ?>">
          <?php if ($thumb || $images) { ?>
          <div class="col-sm-12 new_product_style">
          ...
          <ul class="thumbnails">
            ...
            <li class="image-additional"><a class="thumbnail new_product_style" href="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>"> <img src="<?php echo $image['thumb']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a></li>
            <?php } ?>
            <?php } ?>
          </ul>
          </div>
        ...
        <div class="prices">
          ...
          <div class="btn-group col-md-12 group_produc_cart-padding" role="group" aria-label="Basic example">

					<?php if ($buyoneclick_status) { ?>
					 
						<button type="button" data-loading-text="<?php echo $text_loading; ?>" class="btn quick_cart btn-lg boc_order_btn" <?php if ($buyoneclick_ya_status || $buyoneclick_google_status) { ?> onClick="clickAnalytic(); return true;" <?php } ?> data-toggle="modal" data-target="#boc_order" data-product="<?php echo $heading_title; ?>" data-product_id="<?php echo $product_id; ?>"><?php echo $buyoneclick_name; ?></button>
					<?php }	?>
				
                <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn incart btn-lg"><?php echo $button_cart; ?></button>
              </div>
          ...
          <li><?php echo $text_reward; ?> <?php echo $reward; ?></li>
            ...
            <?php $counter=0; foreach ($attribute_groups as $attribute_group) { ?>
