...
function createformbysort($feild,$label,$required,$status,$alldata) {
	...
	if($feild=='tmdqc_billaddress_lastname'){
        ...
        <label class="control-label" for="input-payment-lastname">'.$label .'</label>
			  <input type="text" name="lastname" value="'.$alldata['lastname'].'" placeholder="'.$label .'" id="input-payment-lastname" class="form-control" />
     </div>';
		return $newfelid;
	}
	...
	if($feild=='tmdqc_billaddress_city'){
        ...
        <label class="control-label" for="input-payment-city">'.$label .'</label>
				<input type="text" name="city" value="'.$alldata['city'].'" placeholder="'.$label .'" id="input-payment-city" class="form-control" />
     </div>';
		return $newfelid;
	}
