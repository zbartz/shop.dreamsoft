...
$('#deliveryaddresscustom .form-group[data-sort]').detach().each(function() {
	if ($(this).attr('data-sort') >= 0 && $(this).attr('data-sort') <= $('#deliveryaddresscustom .form-group').length) {
		$('#deliveryaddresscustom .form-group').eq($(this).attr('data-sort')).before(this);
	}

	if ($(this).attr('data-sort') > $('#deliveryaddresscustom .form-group').length) {
		$('#deliveryaddresscustom .form-group:last').after(this);
	}

	if ($(this).attr('data-sort') < -$('#deliveryaddresscustom .form-group').length) {
		$('#deliveryaddresscustom .form-group:first').before(this);
	}
});
//--></script>
<script type="text/javascript"><!--
	...
	$.ajax({
		...
		success: function(json) {
			if (json['postcode_required'] == '1') {
				$('#tmd_delivery_address input[name=\'postcode\']').parent().addClass('required');
			} else {
				$('#tmd_delivery_address input[name=\'postcode\']').parent().removeClass('required');
			}
...
//--></script>
<script type="text/javascript"><!--
$('#tmd_delivery_address select[name=\'zone_id\']').on('change', function() {
...
function createformbysort($feild,$label,$required,$status,$alldata) {
	...
	if($feild=='tmdqc_deliveryaddress_firstname'){
        ...
        <label class="control-label" for="input-shipping-firstname">'.$label .'</label>
			  <input type="text" name="firstname" value="'.$alldata['firstname'].'" placeholder="'.$label .'" id="input-shipping-firstname" class="form-control" />
     </div>';
		return $newfelid;
	}
	...
	if($feild=='tmdqc_deliveryaddress_lastname'){
        ...
        <label class="control-label" for="input-shipping-lastname">'.$label .'</label>
			  <input type="text" name="lastname" value="'.$alldata['lastname'].'" placeholder="'.$label .'" id="input-shipping-lastname" class="form-control" />
     </div>';
		return $newfelid;
	}
	...
	if($feild=='tmdqc_deliveryaddress_company'){
        ...
        <label class="control-label" for="input-shipping-company">'.$label .'</label>
				<input type="text" name="company" value="'.$alldata['company'].'" placeholder="'.$label .'" id="input-shipping-company" class="form-control" />
     </div>';
		return $newfelid;
	}	
	...
	if($feild=='tmdqc_deliveryaddress_address1'){
        ...
        <label class="control-label" for="input-shipping-address-1">'.$label .'</label>
			  <input type="text" name="address_1" value="'.$alldata['address_1'].'" placeholder="'.$label .'" id="input-shipping-address-1" class="form-control" />
     </div>';
		return $newfelid;
	}
	...
	if($feild=='tmdqc_deliveryaddress_address2'){
        ...
        <label class="control-label" for="input-shipping-address-2">'.$label .'</label>
			  <input type="text" name="address_2" value="'.$alldata['address_2'].'" placeholder="'.$label .'" id="input-shipping-address-2" class="form-control" />
     </div>';
		return $newfelid;
	}
	...
	if($feild=='tmdqc_deliveryaddress_city'){
        ...
        <label class="control-label" for="input-shipping-city">'.$label .'</label>
				<input type="text" name="city" value="'.$alldata['city'].'" placeholder="'.$label .'" id="input-shipping-city" class="form-control" />
     </div>';
		return $newfelid;
	}
	...
	if($feild=='tmdqc_deliveryaddress_postal_code'){
        ...
        <label class="control-label" for="input-shipping-postcode">'.$label .'</label>
				<input type="text" name="postcode" value="'.$alldata['postcode'].'" placeholder="'.$label .'" id="input-shipping-postcode" class="form-control" />
     </div>';
		return $newfelid;
	}
	...
	if($feild=='tmdqc_deliveryaddress_country'){
			$newfelid =	'<div class="form-group '.$required.$status.'"><label class="control-label" for="input-shipping-country">'.$label.'</label><select name="country_id" id="input-shipping-country" class="form-control"><option value="">'. $alldata['text_select'] .'</option>';
