...
#quick-checkout #content{
	<?php if($tmdqc_content_background){ ?>
...
#quick-checkout #tmd_cart table tr {
	<?php if($tmdqc_cart_table_color){ ?>
	color: <?php echo $tmdqc_cart_table_color; ?>;
	<?php } ?>
	<?php if($tmdqc_cart_table_background){ ?>
...
#quick-checkout #tmd_cart table tr td, #quick-checkout #tmd_cart table tr th, #quick-checkout #tmd_cart .table-bordered{
	<?php if($tmdqc_cart_table_border){ ?>
	border-color: <?php echo $tmdqc_cart_table_border; ?> !important;
	<?php } ?>
}
#quick-checkout .panel{
	border:none;
	<?php if($tmdqc_block_heading_background){ ?>
...
#quick-checkout .panel-heading{
	<?php if($tmdqc_block_heading_color){ ?>
...
#quick-checkout .buttons .btn-primary, #quick-checkout .btn-primary{
	<?php if($tmdqc_primary_button_background) { ?>
	background:<?php echo $tmdqc_primary_button_background; ?>!important;
	<?php } ?>
	<?php if($tmdqc_primary_button_border) { ?>
	border-color:<?php echo $tmdqc_primary_button_border; ?>;
	<?php } ?>
	
	<?php if($tmdqc_primary_button_color) { ?>
	color:<?php echo $tmdqc_primary_button_color; ?>;
	<?php } ?>
}
#quick-checkout .buttons .btn-primary:hover, #quick-checkout .btn-primary:hover{
	<?php if($tmdqc_primary_button_background_hover) { ?>
	background:<?php echo $tmdqc_primary_button_background_hover; ?>!important;
	<?php } ?>
}
#quick-checkout .btn-danger{
	<?php if($tmdqc_danger_button_color) { ?>
	color:<?php echo $tmdqc_danger_button_color; ?>;
	<?php } ?>
	<?php if($tmdqc_danger_button_background) { ?>
	background:<?php echo $tmdqc_danger_button_background; ?>;
	<?php } ?>
	<?php if($tmdqc_danger_button_border) { ?>
	border-color:<?php echo $tmdqc_danger_button_border; ?>;
	<?php } ?>
}
#quick-checkout .btn-danger:hover{
	<?php if($tmdqc_danger_button_background_hover) { ?>
...
#accountcontent{
	background:<?php echo $tmdqc_sub_content_background; ?>;border:1px solid <?php echo $tmdqc_sub_content_border; ?>;
}

#tmd_payment_method{
	padding:10px 5px 35px;margin-top:15px;background:<?php echo $tmdqc_sub_content_background; ?>; border:1px solid <?php echo $tmdqc_sub_content_border; ?>;
}

#tmd_shipping_method{
	padding:10px;background:<?php echo $tmdqc_sub_content_background; ?>;border:1px solid <?php echo $tmdqc_sub_content_border; ?>;
}

#tmd_delivery_address{
	padding:10px;margin-bottom:15px;background:<?php echo $tmdqc_sub_content_background; ?>;border:1px solid <?php echo $tmdqc_sub_content_border; ?>;
}
...
#typeaccount a{cursor:pointer;color:<?php echo $tmdqc_cart_heading_color; ?>}
