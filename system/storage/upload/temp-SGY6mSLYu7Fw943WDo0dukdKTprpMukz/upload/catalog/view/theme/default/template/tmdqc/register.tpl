...
function createformbysort($feild,$label,$required,$status,$alldata){
	...
	if($feild=='tmdqc_register_firstname'){
        ...
        <input type="text" name="firstname" value="" placeholder="'.$label .'" id="input-payment-firstname" class="form-control" />
     </div>';
		return $newfelid;
	}
	...
	if($feild=='tmdqc_register_lastname'){
        ...
        <input type="text" name="lastname" value="" placeholder="'.$label .'" id="input-payment-lastname" class="form-control" />
			</div>';
	...
	if($feild=='tmdqc_register_email'){
        ...
        <input type="text" name="email" value="" placeholder="'.$label .'" id="input-payment-email" class="form-control" />
			</div>';
			return $newfelid;
	}
	...
	if($feild=='tmdqc_register_telephone'){
        ...
        <input type="text" name="telephone" value="" placeholder="'.$label .'" id="input-payment-telephone" class="form-control" />
			</div>';
			return $newfelid;
	}
	...
	if($feild=='tmdqc_register_fax'){
        ...
        <input type="text" name="fax" value="" placeholder="'.$label .'" id="input-payment-fax" class="form-control" />
			</div>';
			return $newfelid;
	}
	...
	if($feild=='tmdqc_register_address1'){
        ...
        <input type="text" name="address_1" value="" placeholder="'.$label .'" id="input-payment-address-1" class="form-control" />
			</div>';
			return $newfelid;
	}
	...
	if($feild=='tmdqc_register_company'){
        ...
        <input type="text" name="company" value="" placeholder="'.$label .'" id="input-payment-company" class="form-control" />
			</div>';
			return $newfelid;
	}
	...
	if($feild=='tmdqc_register_city'){
        ...
        <input type="text" name="city" value="" placeholder="'.$label .'" id="input-payment-city" class="form-control" />
			</div>';
			return $newfelid;
	}
	...
	if($feild=='tmdqc_register_address2'){
        ...
        <input type="text" name="address_2" value="" placeholder="'.$label .'" id="input-payment-address-2" class="form-control" />
			</div>';
			return $newfelid;
	}
	...
	if($feild=='tmdqc_register_postal_code'){
        ...
        <input type="text" name="postcode" value="" placeholder="'.$label .'" id="input-payment-postcode" class="form-control" />
			</div>';
			return $newfelid;
	}
	...
	if($feild=='tmdqc_register_password'){
			$newfelid = '<div class="form-group '.$required.$status.'">
				<label class="control-label" for="input-payment-password">'.$label.'</label>
				 <input type="password" name="password" value="" placeholder="'.$label.'" id="input-payment-password" class="form-control" />
				</div>';
			return $newfelid;
	}
	...
	if($feild=='tmdqc_register_cpassword'){
			$newfelid = '<div class="form-group '.$required.$status.'">
				<label class="control-label" for="input-payment-confirm">'.$label.'</label>
				 <input type="password" name="confirm" value="" placeholder="'.$label.'" id="input-payment-confirm" class="form-control" />
				</div>';
			return $newfelid;
	}
