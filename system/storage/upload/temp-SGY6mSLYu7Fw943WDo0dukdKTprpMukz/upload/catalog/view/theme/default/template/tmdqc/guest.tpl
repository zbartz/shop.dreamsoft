...
function createformbysort($feild,$label,$required,$status,$alldata) {
	...
	if($feild=='tmdqc_guest_firstname'){
        ...
        <input type="text" name="firstname" value="'.$alldata['firstname'].'" placeholder="'.$label .'" id="input-payment-firstname" class="form-control" />
     </div>';
		return $newfelid;
	}
	
	if($feild=='tmdqc_guest_lastname'){
		$newfelid =  '<div class="form-group'.$required.$status.'"><label class="control-label" for="input-payment-lastname">'.$label .'</label>
        <input type="text" name="lastname"  value="'.$alldata['lastname'].'" placeholder="'.$label .'" id="input-payment-lastname" class="form-control" /></div>';
		return $newfelid;
	}
	...
	if($feild=='tmdqc_guest_email'){
        ...
        <input type="text" name="email" value="'.$alldata['email'].'" placeholder="'.$label .'" id="input-payment-email" class="form-control" />
     </div>';
		return $newfelid;
	}
	...
	if($feild=='tmdqc_guest_telephone'){
        ...
        <input type="text" name="telephone" value="'.$alldata['telephone'].'"  placeholder="'.$label .'" id="input-payment-telephone" class="form-control" />
     </div>';
		return $newfelid;
	}
	...
	if($feild=='tmdqc_guest_fax'){
        ...
        <input type="text" name="fax" value="'.$alldata['fax'].'" placeholder="'.$label .'" id="input-payment-fax" class="form-control" />
     </div>';
		return $newfelid;
	}
	...
	if($feild=='tmdqc_guest_company'){
        ...
        <input type="text" name="company" value="'.$alldata['company'].'" placeholder="'.$label .'" id="input-payment-company" class="form-control" />
     </div>';
		return $newfelid;
	}
	...
	if($feild=='tmdqc_guest_address1'){
        ...
        <input type="text" name="address_1" value="'.$alldata['address_1'].'" placeholder="'.$label .'" id="input-payment-address-1" class="form-control" />
     </div>';
		return $newfelid;
	}	
	...
	if($feild=='tmdqc_guest_address2'){
        ...
        <input type="text" name="address_2" value="'.$alldata['address_2'].'" placeholder="'.$label .'" id="input-payment-address-2" class="form-control" />
     </div>';
		return $newfelid;
	}
	if($feild=='tmdqc_guest_city'){
        ...
        <input type="text" name="city" value="'.$alldata['telephone'].'" placeholder="'.$label .'" id="input-payment-city" class="form-control" />
     </div>';
		return $newfelid;
	}
	if($feild=='tmdqc_guest_postal_code'){
        ...
        <input type="text" name="postcode" value="'.$alldata['postcode'].'" placeholder="'.$label .'" id="input-payment-postcode" class="form-control" />
     </div>';
		return $newfelid;
	}
	
	if($feild=='tmdqc_guest_country'){
			$newfelid =	'<div class="form-group '.$required.$status.'"><label class="control-label" for="input-payment-country">'.$label.'</label><select name="country_id" id="input-payment-country" class="form-control"><option value="">'. $alldata['text_select'] .'</option>';
