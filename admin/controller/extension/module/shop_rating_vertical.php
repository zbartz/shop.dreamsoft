...
class ControllerExtensionModuleShopRatingVertical extends Controller {
    ...
    public function index() {
        $this->load->language('extension/module/shop_rating_vertical');
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $this->response->redirect($this->url->link('extension/module/shop_rating_vertical', 'token=' . $this->session->data['token'], 'SSL'));
        }
        ...
        $data['action'] = $this->url->link('extension/module/shop_rating_vertical', 'token=' . $this->session->data['token'], 'SSL');
        ...
        if (!isset($this->request->get['module_id'])) {
            $data['breadcrumbs'][] = array(
                ...
                'href' => $this->url->link('extension/module/shop_rating_vertical', 'token=' . $this->session->data['token'], 'SSL')
            );
        } else {
            $data['breadcrumbs'][] = array(
                'text' => $this->language->get('heading_title'),
                'href' => $this->url->link('extension/module/shop_rating_vertical', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL')
            );
        }
        ...
        $this->response->setOutput($this->load->view('extension/module/shop_rating_vertical.tpl', $data));
    }

    private function validate() {
        if (!$this->user->hasPermission('modify', 'extension/module/shop_rating_vertical')) {
