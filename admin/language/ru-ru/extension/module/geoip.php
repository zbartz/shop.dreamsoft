...
$_['text_regions_info'] = 'Эти настройки используются для сопоставления регионов OpenCart и базы ФИАС, когда у вас регионы отличаются от стандартных OpenCart (например, добавлены/отредактированы вручную). Убедитесь, что регионы соответствую друг другу!<br>'
    . '<b>Регионы справа должны быть уникальными, т.е. одному региону не могут одновременно соответствовать 2 разных!</b>';
