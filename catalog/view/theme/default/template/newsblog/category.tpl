  ...
  <div class="row">
    ...
    <div id="content" class="<?php echo $class; ?>"> 
      ...
      <?php if ($articles) { ?>
         ...
         <div class="col-md-12 col-sm-6  text-right hidden-xs">
          <div class="btn-group btn-group-sm group_plitka_news">
           
            <button type="button" id="grid-view" class="btn btn-default btn-plitka" data-toggle="tooltip"  ><img src="../image/plitka.png" alt=""></button>
             <button type="button" id="list-view" class="btn btn-default btn-plitka" data-toggle="tooltip" ><img src="../image/pram.png" alt=""></button>
          </div>
        </div> 
      <div class="row">
        ...
        <div id="news" class="product-layout product-list col-lg-6 col-md-6 col-sm-12 col-xs-12 test">
          <div class="product-thumb news"> 
            <?php if ($article['thumb']) { ?><div class="image news_image"><a href="<?php echo $article['href']; ?>"><img src="<?php echo $article['thumb']; ?>" alt="<?php echo $article['name']; ?>" title="<?php echo $article['name']; ?>" class="img-responsive" /></a></div><?php } ?>
            <div class="news_cap">
            	<div class="col-sm-12">
              ...
              <p class="date"><?php echo $article['date_modified']; ?></p>
				...
				<div class="col-sm-12"><p><?php echo $article['preview']; ?></p></div>
