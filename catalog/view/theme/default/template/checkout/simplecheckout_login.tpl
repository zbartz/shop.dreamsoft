    ...
    <div class="simplecheckout-block-content">
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <a class="colorbox" href="<?php echo $forgotten; ?>"><?php echo $text_forgotten; ?></a>
            </div>
            <a id="simplecheckout_button_login" data-onclick="login" class="button button_oc btn"><span><?php echo $button_login; ?></span></a>
        </fieldset>
    </div>
</div>