...
<?php } ?>
    <div class="table-responsive">
        <table class="simplecheckout-cart table-dishes">
            <colgroup>
                <col class="image">
                <col class="name">
                <col class="model">
            ...
            <?php foreach ($products as $product) { ?>
                ...
                <tr>
                    ...
                    <td class="quantity">
                        <div class="input-group btn-block" style="max-width: 200px;">
                            <span class="input-group-btn">
                                <button class="btn btn-primary button-minus" data-onclick="decreaseProductQuantity" data-toggle="tooltip" type="submit">
                            ...
                            <span class="input-group-btn">
                                <button class="btn btn-primary button-plus" data-onclick="increaseProductQuantity" data-toggle="tooltip" type="submit">
                  ...
                  <!--  <td class="price"><?php echo $product['price']; ?></td>-->
                    ...
                    <td class="remove"> <button class="cart_input-group-btn delete_button" data-onclick="removeProduct" data-product-key="<?php echo !empty($product['cart_id']) ? $product['cart_id'] : $product['key'] ?>" data-toggle="tooltip" type="button">
                                   X
                                </button></td>
                </tr>
                <?php } ?>
     ...
     <div class="col-md-12 col-xs-12 text-center res_total">
