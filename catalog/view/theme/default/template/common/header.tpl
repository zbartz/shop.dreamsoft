        ...
        <li><a href="tel:+2312312312"><img src="../image/tele_icon.png" alt=""> <span class="  tele_new"><?php echo $telephone; ?></a></span> 
          <div class= "div3">
           ...
           <a href="skype:username?call" class="sociallinks_new"><img src="../image/icons8-skype-48.png" alt="Диолд мастер в skype" /></a>
     		...
     		<li class="dropdown"><a href="<?php echo $account; ?>" title="<?php echo $text_account; ?>" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <span class="hidden-xs hidden-sm hidden-md">Войти</span> <span class="caret"></span></a>
          <ul class="dropdown-menu dropdown-menu-right ul_account">
            <?php if ($logged) { ?>
            <li class="li_account"><a href="<?php echo $account; ?>"><?php echo $text_account; ?></a></li>
            <li class="li_account"><a href="<?php echo $order; ?>"><?php echo $text_order; ?></a></li>
            <li class="li_account"><a href="<?php echo $transaction; ?>"><?php echo $text_transaction; ?></a></li>
            <li class="li_account"><a href="<?php echo $download; ?>"><?php echo $text_download; ?></a></li>
            <li class="li_account"><a href="<?php echo $logout; ?>"><?php echo $text_logout; ?></a></li>
            <?php } else { ?>
            <li class="li_account"><a href="<?php echo $register; ?>"><?php echo $text_register; ?></a></li>
            <li class="li_account"><a href="<?php echo $login; ?>"><?php echo $text_login; ?></a></li>
            <?php } ?>
          </ul>
        </li> 
        </ul>
>>>>>>> 89739e9dbd58704fe9d5cba613cf2b51b4c7cbab
