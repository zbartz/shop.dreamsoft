<div class="form-group <?php if ($required) { ?>required<?php } ?> row-<?php echo $id ?>">
    <label class="control-label <?php if($id == 'shipping_field20'){echo $page == 'checkout' ? 'col-sm-3' : 'col-sm-2';}else {echo $page == 'checkout' ? 'col-sm-6' : 'col-sm-2';}?>" for="<?php echo $id ?>"><?php echo $label ?></label>
    <div class="<?php if($id == 'shipping_field20'){echo $page == 'checkout' ? 'col-sm-8' : 'col-sm-10';}else{echo $page == 'checkout' ? 'col-sm-6' : 'col-sm-10';} ?>">
